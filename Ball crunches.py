...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            lank = [landmarks[mp_pose.PoseLandmark.LEFT_ANKLE.value].x,
            ...
            rank = [landmarks[mp_pose.PoseLandmark.RIGHT_ANKLE.value].x,
                    landmarks[mp_pose.PoseLandmark.RIGHT_ANKLE.value].y]
            # Calculate angle
            langle = calculate_angle(lshoulder, lhip, lank)
            rangle = calculate_angle(rshoulder, rhip, rank)
            # Visualize angle
            ...
            if langle > 160 and rangle > 160:
                stage = 'Down'
            if langle < 120 and rangle < 120 and stage == 'Down' :
                stage = 'Up'
                counter += 1
        except:
            pass
